<template>
  <section class="experiencias modern-page">
    <h1 class="experiencias__title">Experiências</h1>

    <div class="experiencias__grid">
      <article v-for="exp in experiencias" :key="exp.id" class="exp-card">
